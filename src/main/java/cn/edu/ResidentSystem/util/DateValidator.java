...
public class DateValidator {
	 ...
	 * 根据时间格式获取所匹配的正则
	 */
	public static final String DateReg="([0-9]{4})[(-|年|/)]?([0-1]?[0-9]{1})[(-|月|/)]?(([0-3]?[0-9]{1})[日]?(((\\s)+([0-2]?[0-9]?)(([:]([0-6]?[0-9]?){1}([:]([0-6]?[0-9]?)?)))?))?)?";
	/**
	 * 各种时间格式<br/>
     ...
     public static Date getdate(String dateStr){
         ...
         try{
             ...
             if(dateStr.indexOf("-")>-1){
            	  ...
            	  */
            	 switch(Strlength){
            	 	case 7:date=getdate(dateStr,"format19");break;
            	 	case 10:date=getdate(dateStr,"format8");break;
            	 	case 13:date=getdate(dateStr,"format7");break;
            	 	case 16:date=getdate(dateStr,"format6");break;
            	 	case 19:date=getdate(dateStr,"format5");break;
            	 }
            	  ...
            	  */
            	 switch(Strlength){
            	 	case 7:date=getdate(dateStr,"format18");break;
	         	 	case 10:date=getdate(dateStr,"format12");break;
	         	 	case 13:date=getdate(dateStr,"format11");break;
	         	 	case 16:date=getdate(dateStr,"format10");break;
	         	 	case 19:date=getdate(dateStr,"format9");break;
	         	 }
            	  ...
            	  */
            	 switch(Strlength){
            	 	case 8:date=getdate(dateStr,"format20");break;
	         	 	case 11:date=getdate(dateStr,"format4");break;
	         	 	case 14:date=getdate(dateStr,"format3");break;
	         	 	case 17:date=getdate(dateStr,"format2");break;
	         	 	case 20:date=getdate(dateStr,"format1");break;
	         	 }
             }else{
            	 /**
            	  * 格式为yyyyMMdd时
            	  */
            	 switch(Strlength){
            	 	case 6:date=getdate(dateStr,"format17");break;
	         	 	case 8:date=getdate(dateStr,"format16");break;
	         	 	case 11:date=getdate(dateStr,"format15");break;
	         	 	case 14:date=getdate(dateStr,"format14");break;
	         	 	case 17:date=getdate(dateStr,"format13");break;
	         	 }
             }
         }catch(Exception ex){
             return null;
