...
return jq.each(function(){
var _48b=$.data(this,"textbox");//alert("initValue:"+_48a);
_48b.options.value=_48a;//_48b.options.value="";//解决如下问题：输入框输入文字后，切换到其他窗口，然后再回到刚才输入框所在窗口，输入框文字被清空
...
return _48e.val();//解决如下问题：输入框输入文字后，切换到其他窗口，然后再回到刚才输入框所在窗口，输入框文字被清空
/*if(_48e.is(":focus")){
return _48e.val();
}else{
